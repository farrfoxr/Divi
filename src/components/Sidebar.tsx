...
export default function Sidebar({ 
  ...
  // Fetch active node here to show Depth globally in the footer
  ...
  return (
    <aside className="flex h-screen w-[300px] flex-col border-r border-[var(--border-subtle)] bg-[var(--bg-sidebar)] text-[var(--text-secondary)]">
      ...
      <div className="mt-auto border-t border-[var(--border-subtle)]">
        {/* Task 1: Depth Indicator (Positioned above buttons) */}
        {activeNode && (
           <div className="flex justify-center py-3 border-b border-[var(--border-subtle)] bg-black/5 dark:bg-white/5">
              <span className="text-xs font-mono text-[var(--text-secondary)] opacity-70">
        ...
        <div className="flex flex-col gap-2 p-4">
          {/* View Graph */}
          <button className="flex w-full items-center justify-center gap-2 rounded-lg px-2 py-2 text-sm text-[var(--text-secondary)] hover:bg-black/5 hover:text-[var(--text-primary)] dark:hover:bg-white/5 transition-colors">
          ...
          <button 
            onClick={onResetDB}
            className="flex w-full items-center justify-center gap-2 rounded-lg px-2 py-2 text-xs font-medium text-red-400 hover:bg-red-50 hover:text-red-600 transition-colors mt-2 border border-red-200/20"
          >
